class Automobile:
    ...
    def __str__(self) -> str:
        return f"Марка автомобиля {self.brand}. Модель автомобиля {self.model}. Запас хода {self.range} км."
...
class PetrolEngine(Automobile):
    ...
    def get_fuel_or_charge(self) -> str:
        ...
        return f"{self.brand} {self.model} осталось {self.range} км. Заправьте бензин на {self.fuel} литров."
...
class ElectroEngine(Automobile):
    ...
    def get_fuel_or_charge(self) -> str:
        ...
        return f"{self.brand} {self.model} осталось {self.range} км. Поставьте на зарядку до {self.charging} %."

if __name__ == "__main__":
    petrol = PetrolEngine("Toyota", "Corolla", 43, 50)
    electro = ElectroEngine("Tesla", "Model 3", 47, 60)

    print(petrol)
    print(electro)
    print(petrol.get_fuel_or_charge())
    print(electro.get_fuel_or_charge())
